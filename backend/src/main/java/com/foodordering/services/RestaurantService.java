// backend/src/main/java/com/foodordering/services/RestaurantService.java
...
public class RestaurantService {
    ...
    public RestaurantResponse createRestaurant(Long userId, RestaurantRequest restaurantRequest) {
        ...
        // Check if the user has the restaurant staff role
        if (!owner.getRole().name().equals("RESTAURANT_STAFF")) {
            throw new BadRequestException("Only restaurant staff can create restaurants");
        }
